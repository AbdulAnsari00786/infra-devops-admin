In the terraform.tfvars file put in your username and password that connects to Vsphere and also put your correct IP whereever you see a * in the last octet of the IP Address.
below is an example
